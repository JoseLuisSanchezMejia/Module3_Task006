...
newArray.push({greeting: "hi ik ben een object"});
console.log(newArray);
...
console.log("energie level van de eerste kat:", catBreeds[0].energy_level);
